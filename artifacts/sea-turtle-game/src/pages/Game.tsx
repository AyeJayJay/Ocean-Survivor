...
const THEMES: Theme[] = [
  ...
  { name: "Kelp Forest",   emoji: "🌿", bgStops: [["#0e1a00",0],["#1c3400",0.3],["#284800",0.7],["#0e1a00",1]], rayColor: "rgba(210,255,60,",   bubbleRgb: "190,255,80",  floorTop: "#1e3400", floorBot: "#0e1c00", floorAccent: "rgba(160,220,20,0.18)", topColors: ["#4a7800","#385e00","#5c9000","#264600"], botColors: ["#68a800","#508400","#80c810","#386200"], topBranchColors: ["#c8f040","#a0d020","#e0ff70"], botBranchColors: ["#b8e030","#90c010","#d8f850"], particleColors: ["#adff2f","#c8f040","#7fff00","#e8ff90"], scoreGlow: "rgba(190,255,40,0.95)", ambient: "rays",       ambientCount: 6 },
