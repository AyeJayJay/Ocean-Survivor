...
const THEMES: Theme[] = [
  ...
  { name: "Kelp Forest",   emoji: "🌿", bgStops: [["#031820",0],["#062e30",0.3],["#0a4038",0.7],["#031820",1]], rayColor: "rgba(160,210,100,",  bubbleRgb: "120,200,170", floorTop: "#0c2818", floorBot: "#061410", floorAccent: "rgba(100,140,40,0.22)", topColors: ["#3d5a1a","#2e4412","#506825","#1e3008"], botColors: ["#2a6045","#1e4835","#387858","#123025"], topBranchColors: ["#b8902a","#8a6a18","#d4aa40"], botBranchColors: ["#a07a20","#7a5c14","#c09838"], particleColors: ["#c0a030","#50b080","#d4c060","#80c8a0"], scoreGlow: "rgba(140,210,90,0.9)",  ambient: "rays",       ambientCount: 6 },
