...
const THEMES: Theme[] = [
  ...
  { name: "Kelp Forest",   emoji: "🌿", bgStops: [["#0a1408",0],["#162808",0.3],["#1e3810",0.7],["#0a1408",1]], rayColor: "rgba(140,180,80,",   bubbleRgb: "120,160,80",  floorTop: "#162008", floorBot: "#0a1005", floorAccent: "rgba(80,120,30,0.25)", topColors: ["#1a3a10","#122a08","#234e18","#0c1e08"], botColors: ["#3a5a20","#2c4818","#4c6e2c","#1e3010"], topBranchColors: ["#7a9440","#5a7428","#9ab455"], botBranchColors: ["#6a8438","#4e6820","#88a448"], particleColors: ["#7a9440","#9ab450","#c8b860","#4a6820"], scoreGlow: "rgba(120,160,60,0.9)",  ambient: "rays",       ambientCount: 6 },
