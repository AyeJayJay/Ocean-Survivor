...
const THEMES: Theme[] = [
  ...
  { name: "Kelp Forest",   emoji: "🌿", bgStops: [["#021a0e",0],["#053d20",0.3],["#085c2e",0.7],["#021a0e",1]], rayColor: "rgba(100,230,150,",  bubbleRgb: "100,220,150", floorTop: "#0a3018", floorBot: "#051508", floorAccent: "rgba(60,180,90,0.18)", topColors: ["#0d5c28","#094a20","#127034","#063018"], botColors: ["#127840","#0d6032","#189850","#084528"], topBranchColors: ["#c8921e","#a07016","#e0b030"], botBranchColors: ["#b07e18","#8a6010","#d0a028"], particleColors: ["#50c878","#38a05a","#c8a030","#80e8a8"], scoreGlow: "rgba(60,200,100,0.9)",  ambient: "rays",       ambientCount: 6 },
