    ...
    >
      ...
      {phase === "loading" && (
        <div style={{ textAlign: "center" }}>
          ...
          <div style={{ color: "rgba(255,255,255,0.45)", fontSize: 13, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
            Loading ad…
          </div>
        </div>
      )}
      ...
      {phase === "failed" && (
        <div style={{ textAlign: "center", padding: "0 32px" }}>
          <div style={{ fontSize: 32, marginBottom: 12 }}>😔</div>
          <p style={{ color: "rgba(255,255,255,0.6)", fontSize: 14, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", marginBottom: 20 }}>
            No ad available right now. Try again later.
          </p>
          <button
            onClick={() => safeComplete(false)}
            style={{ background: "rgba(255,255,255,0.12)", border: "1px solid rgba(255,255,255,0.2)", borderRadius: 20, color: "white", padding: "8px 24px", fontSize: 13, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", cursor: "pointer" }}
          >Close</button>
        </div>
      )}
      ...
      {phase === "preroll" && (
        <div style={{ textAlign: "center", padding: "0 28px", maxWidth: 360 }}>
          ...
          <p style={{
            ...
            fontSize: 13, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", lineHeight: 1.55,
          }}>
          ...
          <div style={{
            ...
            <div style={{ color: "rgba(255,255,255,0.4)", fontSize: 10, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", letterSpacing: "0.08em", marginBottom: 8 }}>
              YOUR REWARD
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <span style={{ fontSize: 24 }}>❤️</span>
              <div>
                <div style={{ color: "white", fontWeight: 700, fontSize: 14, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
                  Extra Life
                </div>
                <div style={{ color: "rgba(180,220,200,0.7)", fontSize: 12, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
          ...
          <button
            ...
            aria-label="No thanks, skip the ad"
            style={{
      ...
      {phase === "watching" && !isNative && (
        <>
          ...
          <div style={{
            ...
            {canSkip ? (
              <button
                ...
                style={{ background: "rgba(255,255,255,0.1)", border: "1px solid rgba(255,255,255,0.2)", borderRadius: 20, color: "rgba(255,255,255,0.7)", padding: "3px 10px", fontSize: 11, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", cursor: "pointer" }}
          ...
          <div style={{ textAlign: "center", padding: "0 32px", maxWidth: 380 }}>
            ...
            <h3 style={{ color: "white", margin: "0 0 8px", fontSize: 18, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", fontWeight: 700 }}>
              {ad.title}
            </h3>
            <p style={{ color: "rgba(200,220,255,0.65)", margin: "0 0 24px", fontSize: 13, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", lineHeight: 1.5 }}>
              {ad.body}
            </p>
            ...
            <div style={{ color: "rgba(255,255,255,0.4)", fontSize: 11, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      ...
      {phase === "reward" && (
        <div style={{ textAlign: "center", padding: "0 32px", maxWidth: 380 }}>
          ...
          <h2 style={{ color: "white", margin: "0 0 8px", fontSize: 22, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", fontWeight: 700 }}>
            Extra Life Earned!
          </h2>
          <p style={{ color: "rgba(180,230,200,0.8)", margin: "0 0 24px", fontSize: 14, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", lineHeight: 1.5 }}>
